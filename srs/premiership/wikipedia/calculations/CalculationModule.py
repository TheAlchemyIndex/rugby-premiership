...
from srs.premiership.wikipedia.calculations.calculators.MeanCalculator import calc_rolling_5_scores_mean
...
def create_calculated_columns(first_season_start, first_season_end, last_season_end):
    ...
    while first_season_end <= last_season_end:
        ...
        df_codes.to_csv("wikipedia/data/calculatedData/Results - " + str(first_season_start) + "-"
                        + str(last_season_end) + ".csv")
        first_season_end += 1
